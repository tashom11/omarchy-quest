...
export const commands: Command[] = [
  ...
  },
  {
    ...
    world: 'windows',
    prompt: {
      fr: 'Tu veux sortir une fenêtre précise (une popup mal placée par exemple) du tiling et l’épingler à taille fixe par-dessus.',
      en: 'You want to pop a specific window (a misplaced popup, for example) out of the tiling layout and pin it at a fixed size on top.',
    },
    answer: 'Super + O',
    distractors: ['Super + Shift + Space', 'Super + Space', 'Super + P'],
    explanation: {
      fr: 'Super + O ("pop") bascule la fenêtre en flottant et la fixe à une taille fixe, épinglée par-dessus la disposition.',
      en: 'Super + O ("pop") toggles the window to floating and pins it at a fixed size on top of the layout.',
    },
    difficulty: 2,
  },
